...
- **RF-24.2c** — **Gasto imputado a una fracción (D-41).** La cuota única de un gasto imputado tampoco muestra «monto ÷ 8»: muestra el gasto íntegro, que se imputó a esa fracción y la descripción que lo justifica.
...
- **CA-24.2c** — Dada la cuota de un gasto imputado a la fracción, entonces el detalle muestra el monto íntegro como cuota, declara la imputación directa y **no** contiene la fórmula de división entre ocho.
