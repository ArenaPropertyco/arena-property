...
**Alcance:** 55 historias de usuario (52 del VSM + HU-58, HU-59 y HU-61; **HU-60 eliminada por D-42**) · 3 requisitos transversales habilitadores · 11 épicas · 4 sprints · **326 SP** · sin backlog post-MVP.

Las reglas de negocio que el VSM dejaba abiertas están resueltas en [docs/decisions.md](../../docs/decisions.md) (D-01…D-43); cada spec referencia las decisiones que implementa.
...
| **3 — Operación, dashboards, finanzas y comisiones** | HU-16, HU-17, HU-39, HU-18, HU-19, HU-20, HU-21, HU-23, HU-24, HU-40, HU-53, HU-54 | 79 |
...
- **Ninguna noche del año queda sin dueño (D-42):** la rejilla cubre 51 o 52 semanas completas; se reparten 48 y todo lo demás —las 3 o 4 semanas que nadie elige y las 1 a 9 noches fuera de la rejilla— es bolsa del Administrador. No hay bolsa comodín ni reserva por noches: **HU-60 queda eliminada**.
- **La unidad de uso es la semana completa (D-42):** no hay reservas por noches ni estadías cortas; la noche solo cuenta el cupo y fija las horas de entrada y salida. HU-59 (ventana de reubicación) es nueva y sube el Sprint 2 a 89 SP: es la primera candidata a recortar si el equipo no absorbe ese volumen.
