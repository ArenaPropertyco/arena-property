...
- **RF-00.1** — La ruta `/` renderiza, en orden: Navbar, Hero con video de fondo y slogan, sección Modelo de negocio, sección Beneficios, CTA principal y Footer.
...
- **CA-00.1** — Dado el manifiesto de la home, entonces contiene exactamente las seis secciones de RF-00.1, en ese orden y sin identificadores duplicados.
- **CA-00.2** — Dada cada sección con CTA, entonces su destino resuelve a una ruta declarada del router: Modelo de negocio → HU-41, Beneficios → HU-42, CTA principal → registro o catálogo.
