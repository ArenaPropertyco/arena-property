...
- [x] **T-020 · Políticas de lectura del registro por rol** — `TR-01 · RF-A.6`
  Hecho cuando: pasa `CA-A.5`.

## Paso 3 · Identidad, roles y permisos

- [x] **T-021 · Migración de `profiles` y `user_roles`** — `HU-04 · RF-04.3` · `HU-07 · RF-07.1`
  Hecho cuando: ambas existen con RLS y el rol `Usuario` se crea por disparador al registrarse.
- [x] **T-022 · Esquema de validación del registro** — `HU-04 · RF-04.1`
...
- [x] **T-026 · Función y guarda de escritura única de la atribución** — `HU-61 · RF-61.5, RF-61.6`
  Hecho cuando: pasan `CA-61.4` y `CA-61.5`.
- [x] **T-027 · Botón de Google en los formularios de ingreso y registro** — `HU-61 · RF-61.1`
  Hecho cuando: ambos formularios muestran el control y emiten el evento, sin consultar Supabase (principio 10).
- [x] **T-028 · Página de retorno del proveedor** — `HU-61 · RF-61.2, RF-61.3, RF-61.4, RF-61.5`
  Hecho cuando: existe la ruta, aplica la atribución pendiente una sola vez y navega al panel.
- [x] **T-029 · Traducción de errores del proveedor** — `HU-61 · RF-61.9`
  Hecho cuando: pasa `CA-61.7`.
- [x] **T-030 · Redirección permitida en local y guía de despliegue** — `HU-61 · RF-61.10`
  Hecho cuando: la ruta de retorno está en `additional_redirect_urls` local y documentada para la nube.
- [x] **T-031 · Mapa de permisos tipado en `shared/permissions`** — `HU-07 · RF-07.2`
  Hecho cuando: pasa `CA-07.1` con la tabla completa de la matriz.
- [x] **T-032 · Capacidades condicionadas por estado** — `HU-07 · RF-07.2b`
  Hecho cuando: el mapa distingue capacidad de rol de capacidad de estado y "reservar" figura como condicionada.
- [x] **T-033 · Middleware de rutas por capacidad** — `HU-07 · RF-07.2`
  Hecho cuando: pasa `CA-07.2`.
- [x] **T-034 · Pantalla de gestión de roles del Superadmin** — `HU-07 · RF-07.3`
  Hecho cuando: solo el Superadmin la abre y puede asignar y retirar roles.
- [x] **T-035 · Auditoría de cambios de rol** — `HU-07 · RF-07.4`
  Hecho cuando: pasa `CA-07.3`.
- [x] **T-036 · Acumulación de roles Propietario + Embajador** — `HU-07 · RF-07.1`
  Hecho cuando: pasa `CA-07.4`.
- [x] **T-037 · Migración de `property_admins`** — `HU-05 · RF-05.2`
  Hecho cuando: existe con RLS y permite alta y baja sin borrar histórico.
- [x] **T-038 · Alta de Administrador por invitación** — `HU-05 · RF-05.1`
  Hecho cuando: pasa `CA-05.1`.
- [x] **T-039 · RLS de propiedades por asignación** — `HU-05 · RF-05.3`
  Hecho cuando: pasan `CA-05.2` y `CA-05.3`.
- [x] **T-040 · Listado de administradores con sus propiedades** — `HU-05 · RF-05.4`
...
- [x] **T-178 · Armado puro del detalle de prorrateo** — `HU-24 · RF-24.1, RF-24.2c, RF-24.4` · D-41
  Hecho cuando: pasan `CA-24.1` y `CA-24.2c`; la cuota imputada no muestra la fórmula de división.
- [x] **T-179 · Detalle de cuota de ingreso y marca de residuo** — `HU-24 · RF-24.2, RF-24.2b` · `TR-02 RF-D.3` · D-39
...
- [x] **T-180 · RLS del detalle por fracción propia** — `HU-24 · RF-24.3`
...
- [x] **T-185 · Migración del ingreso por renta** — `HU-40 · RF-40.1, RF-40.3`
  Hecho cuando: existe vinculado a la reserva, con un solo ingreso vigente por reserva.
- [x] **T-186 · Reparto del ingreso según el origen de la semana** — `HU-40 · RF-40.2` · `TR-02` · D-39
  Hecho cuando: una función pura decide entre prorrateo y atribución a partir del motivo, y pasan `CA-40.1`, `CA-40.3` y `CA-40.4`.
- [x] **T-186b · Comisión de gestión por propiedad** — `HU-40 · RF-40.4, RF-40.5` · `TR-02` · D-39
...
- [x] **T-186c · Aviso al liberar y anulación del ingreso atribuido** — `HU-14 · RF-14.7b` · `HU-40 · RF-40.6` · D-39
