...
[HU-15](./HU15-spec.md), [HU-17](./HU17-spec.md), [HU-21](./HU21-spec.md), [HU-39](./HU39-spec.md), [HU-59](./HU59-spec.md).
...
| Término | Definición |
|---|---|
| **Semana** | **Única** unidad de uso (D-33, D-42). Va del sábado a las 15:00 al sábado siguiente a las 11:00, en `America/Bogota`. Nada más corto se elige, confirma, bloquea ni renta. |
| **Noche** | Unidad de conteo del cupo y de las horas de entrada y salida. **No se reserva suelta** (D-42). |
...
| **Cupo** | Derecho anual de una fracción: **6 semanas** (1 alta, 1 media-alta, 1 media, 3 bajas), equivalentes a 42 noches (7/7/7/21). |
| **Bolsa del Administrador** | Las 3 o 4 semanas de la rejilla que no se reparten **y** las 1 a 9 noches que quedan fuera de ella (D-42); mantenimiento y uso institucional. Las noches sueltas no se rentan. |
| **Bolsa de renta** | Semanas liberadas, canceladas, caducadas, reubicadas o no elegidas, disponibles para renta a terceros. Cada entrada por **liberación voluntaria** se le avisa al Administrador (D-43). |
| **Semana liberada** | Semana que su Propietario cede voluntariamente antes de su entrada (RF-14.7). Es el único camino a la bolsa que conserva dueño: si se renta, el ingreso es suyo, neto de comisión (D-39); si nadie la renta, no percibe nada (D-43). |
...
> Un cambio rige desde el siguiente año calendario, salvo P-02, P-10 y P-11, que rigen desde su fecha de vigencia.
> P-08 (estadía mínima) y P-09 (tope de estadía comodín) quedaron **derogados** por D-42: sin unidades menores que la semana, no hay nada que parametrizar.
...
|---|---|---|---|
| I-01 | Ninguna noche del año queda sin temporada ni sin dueño: rejilla ∪ noches sobrantes (bolsa del Administrador, de forma permanente) = año completo | D-42 | CA-12.9 |
...
| I-04 | Una semana pertenece a lo sumo a una fracción y a lo sumo a una ocupación (confirmación, bloqueo o renta) | D-33, D-42 | CA-12.3, CA-14.9 |
...
| I-06 | Una semana se intercambia solo por otra de la misma temporada y sin confirmación encima | D-28, D-32 | CA-12.10 |
| I-07 | No existe unidad de uso menor que la semana: ni el Propietario ni un tercero reservan noches sueltas | D-42 | CA-39.1, CA-43.2 |
...
| I-11 | La semana liberada voluntariamente se le anuncia al Administrador, y solo su renta a un tercero le paga a la fracción: sin renta no hay ingreso | D-39, D-43 | CA-14.10, CA-40.8 |
     ...
     y fija el orden      año; después el que fije el Administrador)
                       ...
                       3b. Ventana de reubicación por turnos             → bolsa de renta
                           rotativos de 48 h (HU-59, D-36)            6. A 30 días: se cierra la cancelación
                                                                     ...
                                                                     7. Semana liberada → aviso al
                                                                        Administrador → la coloca a un
                                                                        tercero → el ingreso es de esa
                                                                        fracción, neto de comisión (D-43)
```
