...
> **Aplazada el 2026-09-09 (D-32, D-33):** la reubicación queda cubierta por la selección por turnos y los intercambios de semanas de HU-12 RF-12.6. Esta historia se retomará, por semanas, solo si hace falta una ventana anual distinta.
...
- **RF-59.2** — **Turno rotativo:** el orden en que las 8 fracciones acceden a la ventana rota cada año, de forma determinista e independiente de la rotación de asignación (HU-12), de modo que en 8 años cada fracción elige primera una vez. como esta en el desarrollo hasta le momento
...
- **CA-59.2** — Dada una reubicación válida, entonces el cupo por temporada de la fracción sigue siendo 1/1/1/3 (semanas) y las fechas de origen quedan libres.
